...
public class GsonActivity extends AppCompatActivity {
    ...
    private String getRecordApi = "http://cscw.fudan.edu.cn/CISWORK/php/getRecord.php";
    private String getUsernamesApi = "http://cscw.fudan.edu.cn/CISWORK/php/getUsernames.php";
